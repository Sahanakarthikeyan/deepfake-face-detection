...
| **Sensitivity (Recall)** | True positive rate for FAKE detection |
| **Specificity** | True negative rate for REAL detection |
| **F1-Score** | Harmonic mean of precision and recall |
| **ROC-AUC** | Area under the ROC curve |

Evaluation plots generated by `visualization.py`:
...
- XAI computation (IG + SmoothGrad + Occlusion) takes ~30 seconds per image on CPU
...
1. Dong, X. et al. — [CSWin Transformer: A General Vision Transformer Backbone with Cross-Shaped Windows](https://arxiv.org/abs/2107.00652) (CVPR 2022)
2. Zhang, K. et al. — [Joint Face Detection and Alignment using Multi-task Cascaded Convolutional Networks](https://arxiv.org/abs/1604.02878)
3. Sundararajan, M. et al. — [Axiomatic Attribution for Deep Networks (Integrated Gradients)](https://arxiv.org/abs/1703.01365) (ICML 2017)
4. Smilkov, D. et al. — [SmoothGrad: removing noise by adding noise](https://arxiv.org/abs/1706.03825)
5. [Deep Fake Face Detection Dataset — Kaggle](https://www.kaggle.com/datasets/vasubhut/deep-fake-face-detection)

---

<div align="center">
Made with ❤️ using CSWin Transformer + Explainable AI
</div>
